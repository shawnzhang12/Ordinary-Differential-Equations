...
[t,y]=solvesystem_zhan6523(f, t0, tN, x0, h)
...
plot(y(1,:),y(2,:));
hold on;
x = (1/20).*exp(-t./4).*([3;20].*cos(sqrt(151).*t./4)-[sqrt(151);0].*sin(sqrt(151).*t./4)) + 17./20./sqrt(151).*exp(-t./4).*([sqrt(151);0].*cos(sqrt(151).*t./4)+[3;20].*sin(sqrt(151).*t./4));
plot(x(1,:),x(2,:),'o')
legend('solvesystem', 'exact')
hold off;
title('Phase Plots - Improved Euler vs. Exact')
xlabel('x1');
ylabel('x2');
...
x = (1/20).*exp(-t./4).*([3;20].*cos(sqrt(151).*t./4)-[sqrt(151);0].*sin(sqrt(151).*t./4)) + 17./20./sqrt(151).*exp(-t./4).*([sqrt(151);0].*cos(sqrt(151).*t./4)+[3;20].*sin(sqrt(151).*t./4));
plot(x(1,:),x(2,:),'o')
legend('Euler', 'Improved','Exact')
hold off;
title('Phase Plots - Euler vs. Improved Euler vs. Exact')
xlabel('x1');
ylabel('x2');
